...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'login_user', (
            ...
            ('email', self.gf('django.db.models.fields.CharField')(unique=True, max_length=70, db_index=True)),
        ...
        db.create_table(u'login_user_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'login.user'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(u'login_user_groups', ['user_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'User'
        db.create_table(u'login_user_user_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'login.user'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(u'login_user_user_permissions', ['user_id', 'permission_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('login_user_groups')

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table('login_user_user_permissions')
    ...
    models = {
        ...
        u'login.user': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '70', 'db_index': 'True'}),
